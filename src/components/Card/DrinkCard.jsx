...
const DrinkCard = ({ id, image, name, price, handleAddDrink }) => {
  return (
    <div className="my-6 flex max-w-sm flex-col justify-between rounded-lg bg-base-dark-bg-2 shadow">
      ...
      <div className="px-6 pb-6">
        ...
        <div className="flex items-center justify-between ">
          ...
          <button id={id} onClick={handleAddDrink} className="rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-medium text-white">
            Add to cart
          </button>
        </div>
      </div>
